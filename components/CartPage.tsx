      ...
      <div className="w-full flex gap-10">
        <div className="w-2/3 flex flex-col gap-5">
          <h1 className="text-2xl font-bold text-black">
            Cart{" "}
            <span className="font-normal text-lightText">
          ...
          <div>
            <div className="text-xl font-bold flex items-center gap-2 mb-2">
              <Image src={phoneImg} alt="PhoneImage" className="w-10" />
            ...
            <div className="w-full p-5 border-[1px] border-zinc-400 rounded-md flex flex-col gap-4">
              <p className="font-semibold text-sm text-zinc-500">
                Sold and Shipped by{" "}
                <span className="text-black fontsemi">Shoppers.com</span>
              </p>
              ...
              <div>
                {productData.map((item: StoreProduct) => (
                  ...
                  >
                    <div className="w-3/4 flex items-center gap-2 mt-5">
                      <Image
                        className="w-32"
                        width={500}
                        height={500}
                    ...
                    <div className="w-1/4 text-right flex flex-col items-end gap-1">
                      ...
                      <div className="flex items-center text-xs gap-2">
                        <p className="uppercase bg-green-200 text-[8px] px-2 py-[1px]">
                          You save
                        </p>
        ...
        <div className="w-1/3 p-4 mt-24 h-[500px] border-[1px] border-zinc-400 rounded-md flex flex-col justify-center gap-4">
          <div className="w-full flex flex-col gap-4 border-b-[1px] border-b-zinc-200 pb-4">
            {userInfo ? (
              <button
                ...
                className="bg-blue hover:bg-hoverBg w-full text-white h-10 rounded-md font-semibold duration-300"
              >
                Continue to checkout
              </button>
            ) : (
              <button className="bg-blue hover:bg-hoverBg bg-opacity-50 cursor-not-allowed w-full text-white h-10 rounded-md font-semibold duration-300">
                Continue to checkout
              </button>
            )}
            {!userInfo && (
            ...
            {warningMsg && (
              <div className="text-white bg-[#002d58] p-2 rounded-lg flex items-center justify-between gap-4">
          ...
          <div className="w-full flex flex-col border-b-[1px] pb-4">
            <div className="flex flex-col gap-1">
              <div className="text-sm flex justify-between">
                <p className="font-semibold">
                  Subtotal <span> ( {productData.length} items ) </span>
                </p>
                <p className="line-through text-base text-zinc-500">
          ...
          <div className="w-full flex flex-col border-b-[1px] gap-4 border-b-zinc-200 pb-4">
            <div className="flex flex-col gap-1">
              <div className="text-sm flex justify-between">
                <p>Shipping</p>
